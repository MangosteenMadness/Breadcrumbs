...
|---|-----------|---------|----------|--------|
| 1 | spec-author | **Univariate or stage-adjusted?** The abandoned finding F-093 exists precisely because this signal collapsed under stage adjustment. If the live analysis reports a univariate HR without saying so, Cairn will surface its own recorded failure and then walk straight into it on stage. Biologist 1 must lock the design — signature, split rule, and adjustment — *before* the analysis runs, not after seeing the p-value. | warn | open |
