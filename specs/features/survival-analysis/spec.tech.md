...
# Cairn / Survival Analysis — Technical Reference
...
### CRN-ANLY-001 — TCGA slice fetch and cache
...
### CRN-ANLY-002 — Cytotoxic signature scoring
...
### CRN-ANLY-003 — Survival stratification
...
- **Known trap, already recorded in the graph:** the abandoned finding F-093 failed precisely here —
  ...
  Cairn surfacing its own prior failure and then repeating it live would be the worst possible demo.
- **REQ-003:** The analysis reports HR, 95% CI, p, and n, and states whether it is univariate or
  stage-adjusted.

### CRN-ANLY-004 — `run_analysis` tool
